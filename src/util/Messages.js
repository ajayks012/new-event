export const allMessages = {
  error: {
    ...
    errorPublish: "Event(s) failed to publish due to service error",
    errorPublishEvent: "Event failed to publish due to service error",
    errorClaim: "Event failed to Claim due to service error",
  ...
  success: {
    ...
    successPublish: "Selected Events published successfully",
    successPublishEvent: "Event published successfully",
